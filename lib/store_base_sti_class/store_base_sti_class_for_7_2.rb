...
if ActiveRecord::VERSION::STRING =~ /\A7\.2/
  module StoreBaseSTIClass
    ...
    module Associations
      module Preloader
        module ThroughAssociationPatch
          ...
          # See: https://github.com/rails/rails/blob/v7.2.0/activerecord/lib/active_record/associations/preloader/through_association.rb#L104
          def through_scope
      ...
      module AssociationScopePatch
        ...
        # See: https://github.com/rails/rails/blob/v7.2.0/activerecord/lib/active_record/associations/association_scope.rb#L81
      ...
      module HasManyThroughAssociationPatch
        ...
        # See: https://github.com/rails/rails/blob/v7.2.0/activerecord/lib/active_record/associations/has_many_through_association.rb#L56
    ...
    module Reflection
      module PolymorphicReflectionPatch
        ...
        # See: https://github.com/rails/rails/blob/v7.2.0/activerecord/lib/active_record/reflection.rb#L1247
